    ...
    switch (active) {
      ...
      case "visao": return (
        <View>
          ...
          <Li label="Servidor configurÃ¡vel" val="Servidor configurÃ¡vel (Termux/VPS)" />
      ...
      case "stack": return (
        <View>
          ...
          <Li label="IA proxy" val="API gratuita (Gemini 2.5)" />
          ...
          <Li label="Dev" val="Workflows internos" />

          <H2>{"ð Deploy / Build"}</H2>
          <Li label="APK Android" val="EAS Build â profile: preview, distribution: internal" />
          <Li label="Servidor" val="Servidor externo (auto-deploy em push)" />
          <Li label="VariÃ¡vel de env" val="EXPO_PUBLIC_DOMAIN = seu domÃ­nio" />
      ...
      case "telas": return (
        <View>
          ...
          <Li label="hooks/useApiBase.ts" val="Retorna URL do servidor (custom ou padrÃ£o)" />
      ...
      case "terminal": return (
        <View>
          ...
          <Li label="OS" val="Linux (servidor)" />
      ...
      case "ia": return (
        <View>
          ...
          <Li label="â¨ Cortesia Gemini" val="GRÃTIS â proxy via API gratuita. Sem chave necessÃ¡ria." />
          ...
          <P>{"O provedor 'Cortesia Gemini' usa a API gratuita para acessar o Gemini sem custo. A rota /api/ai/chat no servidor faz o proxy com SSE streaming."}</P>
          <Info color={yellow}>{"â ï¸ A Cortesia funciona apenas com o servidor externo. Com Termux, use um provedor com chave prÃ³pria."}</Info>
        </View>
      );
      ...
      case "limites": return (
        <View>
          ...
          <H2>{"ð¤ Servidor Externo (padrÃ£o)"}</H2>
          <Info color={yellow}>{"O servidor pode desligar por inatividade (~30 min sem uso). Ao abrir o app apÃ³s tempo parado, o terminal pode demorar 10-30 segundos para responder enquanto o servidor reinicia."}</Info>
      ...
      case "recriar": return (
        <View>
          ...
          <Step n={3} text={"Execute no servidor:"} />
