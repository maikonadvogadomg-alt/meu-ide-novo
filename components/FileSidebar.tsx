...
// ââ Ãcones e cores por extensÃ£o ââââââââââââââââââââââââââââââââââââââââââââââ
...
// ââ Tipos da Ã¡rvore ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
function buildTree(files: ProjectFile[]): TreeNode[] {
  ...
  for (const file of files) {
    ...
    if (parts[parts.length - 1] === ".gitkeep") {
      // ainda cria as pastas pai mas nÃ£o adiciona o arquivo na Ã¡rvore
      let current = root;
...
// ââ Sheet de contexto (bottom sheet nativo) ââââââââââââââââââââââââââââââââââ
...
// ââ Modal de prompt cross-platform ââââââââââââââââââââââââââââââââââââââââââ
...
// ââ VirtualizaÃ§Ã£o â Ã¡rvore achatada para FlatList (aguentar 50k arquivos) ââââ
interface FlatRow {
  key: string;
  node: TreeNode;
  depth: number;
...
// ââ NÃ³ da Ã¡rvore (versÃ£o flat â sem recursÃ£o interna) âââââââââââââââââââââââââ
...
function TreeNodeRow({
    ...
    return (
      <View>
        ...
        >
          ...
          >
            <Text style={[styles.moreDot, { color: colors.mutedForeground }]}>â®</Text>
          </TouchableOpacity>
        </TouchableOpacity>
        {showSheet && (
          <ContextSheet
  ...
  // NÃ³ de arquivo â aÃ§Ãµes diretas, sem toque duplo
  const { file } = node;
...
// ââ FileSidebar principal âââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export default function FileSidebar({ onClose, onAnalyzeWithAI, onMemoryPress, onMenuPress }: FileSidebarProps) {
  ...
  // Pastas abertas â auto-expande ao trocar de projeto ou importar arquivos
  ...
  useEffect(() => {
    ...
    if (projectChanged || filesGrew) {
      ...
      // abre TODAS as pastas do projeto para o usuÃ¡rio ver a Ã¡rvore inteira
  ...
  // ââ Criar arquivo ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Criar pasta ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  // ââ Exportar ZIP âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.card }]}>
      ...
      {/* ââ MemÃ³ria do Projeto âââââââââââââââââââââââââââââââââââââââââââââââ */}
      <TouchableOpacity
      ...
      {/* ââ Ãrvore de arquivos â FlatList virtualizado (suporta 50k arquivos) ââ */}
      ...
      {/* ââ Campo de criaÃ§Ã£o de arquivo âââââââââââââââââââââââââââââââââââââ */}
      {creating && (
      ...
      {/* ââ BotÃ£o Menu âââââââââââââââââââââââââââââââââââââââââââââââââââââ */}
      {onMenuPress && (
        <TouchableOpacity
          onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium); onMenuPress(); }}
          style={[styles.menuBtn, { borderTopColor: colors.border }]}
      ...
      {/* ââ Prompt cross-platform âââââââââââââââââââââââââââââââââââââââââââ */}
      <PromptModal
        visible={!!prompt}
        title={prompt?.title || ""}
      ...
      {/* ââ Indicador de exportaÃ§Ã£o ZIP ââââââââââââââââââââââââââââââââââââ */}
      {exportingZip && (
